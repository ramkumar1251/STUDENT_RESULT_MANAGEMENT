...
<body>
    ...
    <div class="main-content">
        <h1>About</h1>
        <p>This application is designed to manage student results. It allows the admin to add, remove, and view student records, and students to view their results and download their report in Excel format.</p>
        <p>Password: admin123 and login ID is the 1st (4+1) Letters of password.</p>
